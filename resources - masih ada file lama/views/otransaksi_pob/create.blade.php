...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Purchase Order Bahan Baru</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/pob">Transaksi Purchase Order Bahan</a></li>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;">
									       <label style="color:red;font-size:20px">* </label>									
                                           <label for="Kode" class="form-label">Bahan#</label></th>
                                        <th style="text-align: left;">-</th>
                                        <th style="text-align: left;">Stn</th>
                                        <th style="text-align: right;">Qty</th>
										<th style="text-align: right;">Harga</th>
										<th style="text-align: right;">Total</th>
										<th style="text-align: ket;">Ket</th>
