...
<script>
  $(document).ready(function() {
       ...
       $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('jual/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a>');
		...
		if ( '{{$flagz}}' == 'JL' ) {
			datatable.column(5).visible(true, true)
			datatable.column(7).visible(true, true)
			datatable.column(8).visible(true, true)
			datatable.column(10).visible(true, true)
			...
			datatable.column(8).visible(false, false)
			datatable.column(10).visible(false, false)
