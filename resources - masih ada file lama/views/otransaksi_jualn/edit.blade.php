...
<div class="content-wrapper">
                    ...
                    <form action="{{url('/jual/update/'.$header->NO_ID)}}" method="POST">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NAMAC" id="NAMAC" name="NAMAC" placeholder="Masukkan Nama" value="{{$header->NAMAC}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KOTA" id="KOTA" name="KOTA" placeholder="KOTA" readonly value="{{$header->KOTA}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control TRUCK" id="TRUCK" name="TRUCK" placeholder="Masukkan Truck" value="{{$header->TRUCK}}" readonly>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control SOPIR" id="SOPIR" name="SOPIR" placeholder="SOPIR" readonly value="{{$header->SOPIR}}" readonly>
                                </div>
                            </div>
							...
							<table id="datatable" class="table table-striped table-border">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
										    <input type="hidden" name="NO_ID[]" id="NO_ID{{$no}}" type="text" value="{{$juald->NO_ID}}" 
                                            class="form-control NO_ID" onkeypress="return tabE(this,event)" readonly>
											
                                            <input name="REC[]" id="REC{{$no}}" type="text" value="{{$juald->REC}}" class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG{{$no}}" type="text" value="{{$juald->KD_BRG}}" class="form-control KD_BRG" required>
                                        </td>
                                        <td>
                                            <input name="NA_BRG[]" id="NA_BRG{{$no}}" type="text" value="{{$juald->NA_BRG}}" class="form-control NA_BRG" readonly required>
                                        </td>
                                        <td>
                                            <input name="SATUAN[]" id="SATUAN{{$no}}" type="text" value="{{$juald->SATUAN}}" class="form-control SATUAN" required>
                                        </td>
										
										<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="{{$juald->QTY}}" id="QTY{{$no}}" type="text" style="text-align: right"  class="form-control QTY text-primary"></td>                         
										<td><input name="HARGA[]" onclick="select()" onkeyup="hitung()" value="{{$juald->HARGA}}" id="HARGA{{$no}}" type="text" style="text-align: right"  class="form-control HARGA text-primary"></td>
										<td><input name="TOTAL[]" onclick="select()" onkeyup="hitung()" value="{{$juald->TOTAL}}" id="TOTAL{{$no}}" type="text" style="text-align: right"  class="form-control TOTAL text-primary" readonly></td>
                                        
										<td>
                                            <input name="KET[]" id="KET{{$no}}" type="text" value="{{$jual->KET}}" class="form-control KET" required>
                                        </td>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="browseAccountModalLabel">Cari SO</h5>
	...
	<div class="modal fade" id="browseAccount1Modal" tabindex="-1" role="dialog" aria-labelledby="browseAccount1ModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="browseAccount1ModalLabel">Cari Barang</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>
