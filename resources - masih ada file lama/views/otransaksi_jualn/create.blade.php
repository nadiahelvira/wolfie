...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Penjualan Baru</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/jual">Transaksi Penjualan </a></li>
                    ...
                    <form action="store" method="POST">
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NO_SO" id="NO_SO" name="NO_SO" placeholder="Masukkan SO" >
                                </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NAMAC" id="NAMAC" name="NAMAC" placeholder="Masukkan Nama" readonly>
                                </div>
                            </div>
