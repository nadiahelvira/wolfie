...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Transaksi Hutang {{$NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/thut')}}">Transaksi Hutang </a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/thut/update/'.$NO_ID)}}" id="entri" method="POST">
                        @csrf
...
-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Tujuan" value="{{$KODEC}}" readonly>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control TRUCK" id="TRUCK" name="TRUCK"
                                    placeholder="-" value="{{$TRUCK}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label for="TGL_KRM" class="form-label">Tgl-Krm </label>
                                </div>
                                <div class="col-md-4">

								  <input class="form-control date" id="TGL_KRM" name="TGL_KRM" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{date('d-m-Y',strtotime($TGL_KRM))}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label for="TGL_BKR" class="form-label">Tgl_Bkr </label>
                                </div>
                                <div class="col-md-4">

								  <input class="form-control date" id="TGL_BKR" name="TGL_BKR" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{date('d-m-Y',strtotime($TGL_BKR))}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control KG" id="KG" name="KG"
                                    placeholder="-" value="{{ number_format( $KG, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control HARGA" id="HARGA" name="HARGA"
                                    placeholder="-" value="{{ number_format( $HARGA, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="-" value="{{ number_format( $TOTAL1, 0, '.', ',') }}" style="text-align: right"  readonly >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control B_INAP" id="B_INAP" name="B_INAP"
                                    placeholder="-" value="{{ number_format( $B_INAP, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control B_BON" id="B_BON" name="B_BON"
                                    placeholder="-" value="{{ number_format( $B_BON, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control B_MSOL" id="B_MSOL" name="B_MSOL"
                                    placeholder="-" value="{{ number_format( $B_MSOL, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control B_LAIN" id="B_LAIN" name="B_LAIN"
                                    placeholder="-" value="{{ number_format( $B_LAIN, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="-" value="{{ number_format( $TOTAL, 0, '.', ',') }}" style="text-align: right"  readonly >
                                </div>
                            </div>
