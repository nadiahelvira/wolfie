...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Pemakaian Bahan {{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/beli')}}">Pemakaian Bahan</a></li>
                ...
                <div class="card-body">
                    <form action="{{url('/beli/update/'.$header->NO_ID)}}" method="POST">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                <div class="col-md-2">
                                    <label for="KD_BRG" class="form-label">Item#</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control KD_BRG" id="KD_BRG" name="KD_BRG"
                                    placeholder="Masukkan Item#" value="{{$header->KD_BRG}}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="-" value="{{$header->NA_BRG}}" >
                                </div>
                            </div>
...
//////////////////////////////////////////////////////////////////
    ...
    function tambah() {
        ...
        var td6 = x.insertCell(6);
        var td7 = x.insertCell(7);
