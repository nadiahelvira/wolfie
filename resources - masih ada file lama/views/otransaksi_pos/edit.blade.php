...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Purchase Order Sparepart {{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/pos')}}">Transaksi Purchase Order Sparepart</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/pos/update/'.$header->NO_ID)}}" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NAMAS" id="NAMAS" name="NAMAS" placeholder="Masukkan Nama" value="{{$header->NAMAS}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control VIA" id="VIA" name="VIA" placeholder="Masukkan VIA" value="{{$header->VIA}}">
                                </div>
                            </div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $pod)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="KD_BHN[]" id="KD_BHN{{$no}}" type="text" class="form-control KD_BHN" value="{{$pod->KD_BHN}}" required>
                                        </td>
                                        <td>
                                            <input name="NA_BHN[]" id="NA_BHN{{$no}}" type="text" class="form-control NA_BHN" value="{{$pod->NA_BHN}}" readonly required>
                                        </td>
                                        <td>
