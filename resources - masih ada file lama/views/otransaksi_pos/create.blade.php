...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Purchase Order Sparepart Baru</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/pos">Transaksi Purchase Order Sparepart</a></li>
                    ...
                    <form action="store" method="POST">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label for="JTEMPO" class="form-label">Kirim Sebelum</label>
                                </div>
                                <div class="col-md-4">
