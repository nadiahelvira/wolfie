...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Uang Muka Pembelian Baru</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/um">Uang Muka Pembelian</a></li>
                    ...
                    <form action="store" id="entri"  method="POST">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text"  onclick="select()" class="form-control TOTAL1" id="TOTAL" name="TOTAL1" placeholder="TOTAL1" value="{{ number_format(0, 0, '.', ',') }}" style="text-align: right">
                                </div>
