...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Data Uang Muka Pembelian {{$NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/um')}}">Uang Muka Pembelian </a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/um/update/'.$NO_ID)}}" id="entri" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Cash#" value="{{$BACNO}}" readonly>
                                </div>
							</div>	
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan -" value="{{$BNAMA}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="-" value="{{ number_format( $TOTAL1, 0, '.', ',') }}" style="text-align: right"  >
                                </div>
                            </div>
...
<script>
 ...
 function simpan() {
    	...
    	var TOTAL1X = parseFloat($('#TOTAL').val().replace(/,/g, ''));
