...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            	<h1 class="m-0">Tambah Surat Jalan</h1>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/surats">Transaksi Surat Jalan </a></li>
                    ...
                    <form action="store" id="entri" method="POST">
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control SOPIR" id="SOPIR" name="SOPIR" placeholder="Sopir">
                                </div>
                                <div class="col-md-1">
                                </div>
                                <div class="col-md-4">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control NOTES" id="NOTES" name="NOTES" placeholder="Notes">
                                </div>
                            </div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
											...
											<input name="NO_TERIMA[]" id="NO_TERIMA0" type="text" class="form-control NO_TERIMA" readonly hidden>
											<input name="MERK[]" id="MERK0" type="text" class="form-control MERK" readonly hidden>
											<input name="NO_SERI[]" id="NO_SERI0" type="text" class="form-control NO_SERI" readonly hidden>
											<input name="TYP[]" id="TYP0" type="text" class="form-control TYP" readonly hidden>
											<input name="ID_SOD[]" id="ID_SOD0" type="text" class="form-control ID_SOD" readonly hidden>
                                        </td>
                                        <td>
                                            <input name="NO_SO[]" id="NO_SO0" type="text" class="form-control NO_SO" placeholder="No SO" readonly required>
                                        </td>
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG0" type="text" class="form-control KD_BRG" placeholder="Barang#" readonly required>
                                        </td>
                                        <td>
                                            <input name="NA_BRG[]" id="NA_BRG0" type="text" class="form-control NA_BRG" placeholder="Nama" readonly required>
                                        </td>
                                        <td>
                                            <input name="SATUAN[]" id="SATUAN0" type="text" class="form-control SATUAN" placeholder="Satuan" readonly required>
                                        </td>
										<td>
											<input name="QTY[]" onclick="select()" onkeyup="hitung()" value="0" id="QTY0" type="text" style="text-align: right"  class="form-control QTY text-primary">
										</td>                         
										<td>
											<input name="HARGA[]" onclick="select()" onkeyup="hitung()" value="0" id="HARGA0" type="text" style="text-align: right"  class="form-control HARGA text-primary">
										</td>
										<td>
											<input name="TOTAL[]" onclick="select()" onkeyup="hitung()" value="0" id="TOTAL0" type="text" style="text-align: right"  class="form-control TOTAL text-primary" readonly>
										</td>
										<td>
								...
								<tfoot>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><input class="form-control TQTY  text-primary font-weight-bold" style="text-align: right"  id="TQTY" name="TQTY" value="0" readonly></td>
                                    <td></td>
...
//////////////////////////////////////////////////////////////////////
    ...
    function tambah() {
		...
		td6.innerHTML = "<input name='QTY[]' onclick='select()' onkeyup='hitung()' value='0' id='QTY" + idrow + "' type='text' style='text-align: right' class='form-control QTY  text-primary' required>";
		td7.innerHTML = "<input name='HARGA[]' onclick='select()' onkeyup='hitung()' value='0' id='HARGA" + idrow + "' type='text' style='text-align: right' class='form-control HARGA  text-primary' required>";
 		td8.innerHTML = "<input name='TOTAL[]' onclick='select()' onkeyup='hitung()' value='0' id='TOTAL" + idrow + "' type='text' style='text-align: right' class='form-control TOTAL text-primary' required readonly>";
