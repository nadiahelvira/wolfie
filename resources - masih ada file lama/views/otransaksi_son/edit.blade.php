...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Sales Order {{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/so/update/'.$header->NO_ID)}}" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Nomor Bukti" value="{{$header->NO_BUKTI}}" readonly>
                                </div>
								...
								@foreach ($detail as $sod)
                                    <tr>
                                        <td>
                                            ...
                                            <input name="REC[]" id="REC{{$no}}" type="text" value="{{$sod->REC}}" class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG{{$no}}" type="text" class="form-control KD_BRG " value="{{$sod->KD_BRG}}" required>
                                        </td>
                                        <td>
                                            <input name="NA_BRG[]" id="NA_BRG{{$no}}" type="text" class="form-control NA_BRG" value="{{$sod->NA_BRG}}" readonly required>
                                        </td>
                                        <td>
                                            <input name="SATUAN[]" id="SATUAN{{$no}}" type="text" class="form-control SATUAN" value="{{$sod->SATUAN}}" required>
                                        </td>
										
										<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="{{$sod->QTY}}" id="QTY{{$no}}" type="text" style="text-align: right"  class="form-control QTY text-primary" ></td>                         
										<td><input name="HARGA[]" onclick="select()" onkeyup="hitung()" value="{{$sod->HARGA}}" id="HARGA{{$no}}" type="text" style="text-align: right"  class="form-control HARGA text-primary"></td>
										<td><input name="TOTAL[]" onclick="select()" onkeyup="hitung()" value="{{$sod->TOTAL}}" id="TOTAL{{$no}}" type="text" style="text-align: right"  class="form-control TOTAL text-primary" readonly></td>
                                        
										<td>
                                            <input name="KET[]" id="KET{{$no}}" type="text" class="form-control KET" value="{{$sod->KET}}" required>
                                        </td>
