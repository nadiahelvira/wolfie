...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Hasil Produksi {{$NO_BUKTI}}</h1>	
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/hasilpro')}}">Hasil Produksi </a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/hasilpro/update/'.$NO_ID)}}" id="entri" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control NO_PAKAI" id="NO_PAKAI" name="NO_PAKAI" placeholder="No Pakai" value="{{$NO_PAKAI}}" readonly>
                                </div>
							</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control HASIL" id="HASIL" name="HASIL" placeholder="Hasil" value="{{$HASIL}}" style="text-align: right">
                                </div>
							</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control KODEC" id="KODEC" name="KODEC" placeholder="Kode Customer" value="{{$KODEC}}" readonly>
                                </div>
							</div>
                            ...
                            <div class="form-group row">        
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control NAMAC" id="NAMAC"name="NAMAC" placeholder="Nama Customer" value="{{$NAMAC}}" readonly>
                                </div>
							</div>			
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control NO_SO" id="NO_SO" name="NO_SO" placeholder="No Sales Order" value="{{$NO_SO}}" readonly>
                                </div>
							</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control KD_BRG" id="KD_BRG" name="KD_BRG" placeholder="Kode Barang" value="{{$KD_BRG}}" readonly>
                                </div>
							</div>	
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control NA_BRG" id="NA_BRG" name="NA_BRG" placeholder="Nama Barang" value="{{$NA_BRG}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control QTY" id="QTY" name="QTY" placeholder="QTY" value="{{$QTY}}" style="text-align: right">
                                </div>
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control SATUAN" id="SATUAN" name="SATUAN" placeholder="Satuan" value="{{$SATUAN}}" readonly>
                                </div>
							</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control NO_SERI" id="NO_SERI" name="NO_SERI" placeholder="No Seri" value="{{$NO_SERI}}" readonly>
                                </div>
							</div>
                            ...
                            <div class="form-group row">				
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control NOTES" id="NOTES" name="NOTES" placeholder="Masukkan Notes" value="{{$NOTES}}">
                                </div>
							</div>
                        </div>
