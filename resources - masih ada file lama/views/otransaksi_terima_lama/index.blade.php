...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transaksi Terima {{$JUDUL}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Transaksi Terima {{$JUDUL}}</li>
            </ol>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('terima/create')}}?JNSHP={{$JNSHP}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
    });
</script>
@endsection
