...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/stockb')}}">Koreksi Stock</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/stockb/update/'.$header->NO_ID)}}" method="POST">
                        @csrf
                            ...
                            <table id="datatable" class="table table-striped table-border">
                                <thead>
                                    <tr>
										...
										<th style="text-align: center;">Qty-R</th>
								...
								<?php $no=0 ?>
								@foreach ($detail as $stockbd)
                                    <tr>
                                        <td>
										    <input type="hidden" name="NO_ID[]" id="NO_ID{{$no}}" type="text" value="{{$stockbd->NO_ID}}" 
                                            class="form-control NO_ID" onkeypress="return tabE(this,event)" readonly>
                                            
											<input name="REC[]" id="REC{{$no}}" type="text" value="{{$stockbd->REC}}" class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG{{$no}}" type="text" value="{{$stockbd->KD_BRG}}" class="form-control KD_BRG" readonly required>
                                        </td>
                                        <td>
                                            <input name="NA_BRG[]" id="NA_BRG{{$no}}" type="text" value="{{$stockbd->NA_BRG}}" class="form-control NA_BRG" readonly required>
                                        </td>
                                        <td>
                                            <input name="SATUAN[]" id="SATUAN{{$no}}" type="text" value="{{$stockbd->SATUAN}}" class="form-control SATUAN" readonly required>
                                        </td>
										
										<td><input name="QTYC[]" onclick="select()" onkeyup="hitung()" value="{{$stockbd->QTYC}}" id="QTYC{{$no}}" type="text" style="text-align: right"  class="form-control QTYC text-primary"></td>                         
										<td><input name="QTYR[]" onclick="select()" onkeyup="hitung()" value="{{$stockbd->QTYR}}" id="QTYR{{$no}}" type="text" style="text-align: right"  class="form-control QTYR text-primary"></td>
										<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="{{$stockbd->QTY}}" id="QTY{{$no}}" type="text" style="text-align: right"  class="form-control QTY text-primary" readonly></td>
                                        
										<td>
                                            <input name="KET[]" id="KET{{$no}}" type="text" class="form-control KET" value="{{$stockbd->KET}}" required>
                                        </td>
...
//////////////////////////////////////////////////////////////////
    ...
    function tambah() {
        ...
        td2.innerHTML = "<input name='KD_BRG[]' data-rowid='"+idrow+"'  id=KD_BRG" + idrow + " type='text' class='form-control KD_BRG'  readonly required>";
