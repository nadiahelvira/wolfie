...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Koreksi Stock Barang Baru</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/stockb">Transaksi Koreksi Stock Barang </a></li>
                            ...
                            <table id="datatable" class="table table-striped table-border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG0" type="text" class="form-control KD_BRG" readonly required>
                                        </td>
                                        <td>
										...
										<td><input name="QTYC[]" onclick="select()" onkeyup="hitung()" value="0" id="QTYC0" type="text" style="text-align: right"  class="form-control QTYC text-primary"></td>                         
										<td><input name="QTYR[]" onclick="select()" onkeyup="hitung()" value="0" id="QTYR0" type="text" style="text-align: right"  class="form-control QTYR text-primary"></td>
										<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="0" id="QTY0" type="text" style="text-align: right"  class="form-control QTY text-primary" readonly></td>
...
//////////////////////////////////////////////////////////////////
    ...
    function tambah() {
        ...
        td4.innerHTML = "<input name='SATUAN[]'   id=SATUAN" + idrow + " type='text' class='form-control  SATUAN' required reaodnly>";
