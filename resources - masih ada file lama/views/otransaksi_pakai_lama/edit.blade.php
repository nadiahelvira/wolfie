...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Pemakaian {{$JUDUL}} {{$header->NO_BUKTI}}</h1>	
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/pakai?JNSPK=')}}{{$header->FLAG}}">Transaksi Pemakaian {{$JUDUL}}</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/pakai/update/'.$header->NO_ID)}}" id="entri" method="POST">
                        @csrf
								...
								@foreach ($detail as $pakaid)	
                                    <tr>
                                        <td>
											...
											<input name="REC[]" id="REC{{$no}}" type="text" class="form-control REC" onkeypress="return tabE(this,event)" value="{{$pakaid->REC}}" style="text-align: center;" readonly>
                                        </td>
                                        <td>
                                            <input name="KD_BHN[]" id="KD_BHN{{$no}}" type="text" class="form-control KD_BHN" placeholder="Bahan#" value="{{$pakaid->KD_BHN}}" readonly required>
                                        </td>
                                        <td>
                                            <input name="NA_BHN[]" id="NA_BHN{{$no}}" type="text" class="form-control NA_BHN" value="{{$pakaid->NA_BHN}}" readonly required>
                                        </td>
                                        <td>
                                            <input name="SATUAN[]" id="SATUAN{{$no}}" type="text" class="form-control SATUAN" placeholder="Satuan" value="{{$pakaid->SATUAN}}" readonly required>
                                        </td>   
										<td>
											<input name="QTY[]" onclick="select()" onkeyup="hitung()" value="{{$pakaid->QTY}}" id="QTY{{$no}}" type="text" style="text-align: right"  class="form-control QTY text-primary"> <input name="QTYX[]" value="{{$pakaid->QTYX}}" id="QTYX{{$no}}" type="text" class="form-control QTYX text-primary" readonly hidden>
										</td>   
										<td>
                                            <input name="KET[]" id="KET{{$no}}" type="text" class="form-control KET" placeholder="Ket" value="{{$pakaid->KET}}" required>
                                        </td>
