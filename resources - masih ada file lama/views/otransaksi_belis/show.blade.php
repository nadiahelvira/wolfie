...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Lihat Pembelian Non</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/belin')}}">Transaksi Pembelian Non</a></li>
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $belin)
                                    <tr>
                                        ...
                                        <td>
                                            <input name="KD_BHN[]" id="KD_BHN0" type="text" value="{{$belin->KD_BHN}}" class="form-control KD_BHN" required readonly>
                                        </td>
                                        <td>
                                            <input name="NA_BHN[]" id="NA_BHN0" type="text" value="{{$belin->NA_BHN}}" class="form-control NA_BHN" readonly required>
                                        </td>
                                        <td>
                                            <input name="STN[]" id="STN0" type="text" value="{{$belin->STN}}" class="form-control STN" required readonly>
                                        </td>
										
										<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="{{$belin->QTY}}" id="QTY0" type="text" style="text-align: right"  class="form-control QTY text-primary"readonly></td>                         
										<td><input name="HARGA[]" onclick="select()" onkeyup="hitung()" value="{{$belin->HARGA}}" id="HARGA0" type="text" style="text-align: right"  class="form-control HARGA text-primary"readonly></td>
										...
										<td>
                                            <input name="KET[]" id="KET0" type="text" value="{{$belin->KET}}" class="form-control KET" required readonly>
                                        </td>
