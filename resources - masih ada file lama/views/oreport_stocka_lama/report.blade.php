	...
	<div class="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="col-sm-6">
<!-- GANTI 1 -->
				<h1 class="m-0">Laporan Koreksi Stock Bahan Baku </h1>
			</div>
			<!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
<!-- GANTI 2 -->
				<li class="breadcrumb-item active">Laporan Koreksi Stock Bahan Baku </li>
				</ol>
			</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
...
// GANTI 3.1 SESUAI GANTI 2.1
			function fill_datatable( kd_bhn = '' , tglDr = '', tglSmp = '' )
			{
...
// GANTI 5.1 SESUAI GANTI 2.1
				var kd_bhn = $('#kd_bhn').val();
				var tglDr = $('#tglDr').val();
				var tglSmp = $('#tglSmp').val();
				
				if (kd_bhn != '' || (tglDr != '' && tglSmp != ''))
				{
			...
			$('#resetfilter').click(function() {
				...
				$('.datatable').DataTable().destroy();
				fill_datatable(kd_bhn, tglDr, tglSmp);
// BATAS GANTI 5.1
			});
		});
	</script>
