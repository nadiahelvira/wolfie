...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Purchase Order Non{{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/pon/update/'.$header->NO_ID)}}" method="POST">
                        @csrf
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $pod)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG{{$no}}" type="text" class="form-control KD_BRG" value="{{$pod->KD_BRG}}" required>
                                        </td>
                                        <td>
                                            <input name="NA_BRG[]" id="NA_BRG{{$no}}" type="text" class="form-control NA_BRG" value="{{$pod->NA_BRG}}" readonly required>
                                        </td>
                                        <td>
