            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{($tipx=='new')? url('/fo/store?flagz='.$flagz.'') : url('/fo/update/'.$header->NO_ID.'&flagz='.$flagz.'' ) }}" method="POST" name ="entri" id="entri" >
                        ...
                        <div class="tab-content mt-3">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item active">
									<a class="nav-link active" href="#fodInfo" data-toggle="tab">Formula</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" href="#fod2Info" data-toggle="tab" >Tahapan</a>
								</li>
							</ul>
                        ...
                        <div class="tab-content mt-3">
							<div id="fodInfo" class="tab-pane active">
						...
						<div id="fod2Info" class="tab-pane">
