...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Journal Bank Keluar {{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/bankk/update/'.$header->NO_ID)}}" id="entri" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $bankd)
                                    <tr>
                                         <td>
                                            <input type="hidden" name="NO_ID[]" id="NO_ID{{$no}}" type="text" value="{{$bankd->NO_ID}}" 
                                            class="form-control NO_ID" onkeypress="return tabE(this,event)" readonly>
                                            
                                            <input name="REC[]" id="REC{{$no}}" type="text" value="{{$bankd->REC}}" 
                                            class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="ACNO[]"  data-rowid={{$no}} id="ACNO{{$no}}" type="text" value="{{$bankd->ACNO}}"
                                            class="form-control ACNO" readonly required>
                                        </td>
										
                                        <td>
                                            <input name="NACNO[]" id="NACNO{{$no}}" type="text" value="{{$bankd->NACNO}}"
                                            class="form-control NACNO" readonly required>
                                        </td>
										
										<td>
                                            <input name="URAIAN[]" id="URAIAN{{$no}}" type="text" value="{{$bankd->URAIAN}}"
                                            class="form-control URAIAN" required>
                                        </td>
										<td>
                                            <input name="JUMLAH[]" onclick="select()"  style="text-align: right" onkeyup="hitung()" id="JUMLAH{{$no}}" type="text" value="{{$bankd->JUMLAH}}"
