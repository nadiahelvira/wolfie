...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Lihat Journal Bank Keluar</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('bankk')}}">Journal Bank Keluar</a></li>
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
					...
					-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Cash#" value="{{$header->BACNO}}" readonly>
                                </div>
							</div>	
					...
					<!--		<div class="form-group row">							
								<div class="col-md-2">
                                    <label for="BG" class="form-label">BG</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control BG" id="BG"name="BG"
                                    placeholder="Masukkan BG" value="{{$header->BG}}" readonly>
                                </div>
							</div>	
							...
							<div class="form-group row">							
                                ...
                                <div class="col-md-4">
								  <input class="form-control date" id="JTEMPO" name="JTEMPO" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{$header->JTEMPO}}" readonly>
                                </div>
                            </div>
						-->	
							...
							<div class="form-group row">							
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Notes" value="{{$header->KET}}" readonly>
                                </div>
							</div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
                                ...
                                <tbody>
								<?php $no=0 ?>
								@foreach ($detail as $bankd)
                                    <tr>
                                         <td>
                                            <input type="hidden" name="NO_ID[]" id="NO_ID0" type="text" value="{{$bankd->NO_ID}}" 
                                            class="form-control NO_ID" onkeypress="return tabE(this,event)" readonly>
                                            
                                            <input name="REC[]" id="REC0" type="text" value="{{$bankd->REC}}" 
                                            class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="ACNO[]" id="ACNO0" type="text" value="{{$bankd->ACNO}}"
                                            class="form-control ACNO" readonly>
                                        </td>
										
                                        <td>
                                            <input name="NACNO[]" id="NACNO0" type="text" value="{{$bankd->NACNO}}"
                                            class="form-control NACNO" readonly>
                                        </td>
										
										<td>
                                            <input name="URAIAN[]" id="URAIAN0" type="text" value="{{$bankd->URAIAN}}"
                                            class="form-control URAIAN" readonly>
                                        </td>
										<td>
                                            <input name="JUMLAH[]" onclick="select()" onkeyup="hitung()" id="JUMLAH0" type="text" style="text-align: right" value="{{$bankd->JUMLAH}}"
