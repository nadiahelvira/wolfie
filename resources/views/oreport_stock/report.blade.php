		...
		<div class="row">
			...
			<div class="card">
				<div class="card-body">
					...
					<form method="POST" action="{{url('jasper-stock-report')}}">
					@csrf
					<div class="form-group row">
						...
						<div class="col-md-2">						
							...
							<input type="text" class="form-control KD_BRG" id="KD_BRG" name="KD_BRG" placeholder="Pilih Barang" value="{{ session()->get('filter_kdbrg1') }}" >
						</div>  
						<div class="col-md-3">
					...
					<button class="btn btn-danger" type="button" id="resetfilter" class="resetfilter" onclick="window.location='{{url("rstock")}}'">Reset</button>
