...
<style>
    .card {
        ...
        background-image: linear-gradient(180deg, hsla(177, 87%, 79%, 0.5) 0%, hsla(235, 89%, 70%, 0.5) 100%),
            url("http://bumiuniversalmakmur.duckdns.org/foxie/public/img/bg01.jpg"); 
    }
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit Journal Kas Keluar {{$header->NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/kask/update/'.$header->NO_ID)}}" id="entri" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                <div class="col-md-2">
                                    <label for="KET" class="form-label">Dari/Ke</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control KET" id="KET" name="KET" placeholder="Masukkan Dari/Ke">
                                </div>
                            </div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $kasd)
                                    <tr>
                                         <td>
                                            <input type="hidden" name="NO_ID[]" id="NO_ID{{$no}}" type="text" value="{{$kasd->NO_ID}}" 
                                            class="form-control NO_ID" onkeypress="return tabE(this,event)" readonly>
                                            
                                            <input name="REC[]" id="REC{{$no}}" type="text" value="{{$kasd->REC}}" 
                                            class="form-control REC" onkeypress="return tabE(this,event)" readonly>
                                        </td>
                                        <td>
                                            <input name="ACNO[]" data-rowid={{$no}} id="ACNO{{$no}}" type="text" value="{{$kasd->ACNO}}"
                                            class="form-control ACNO" required readonly >
                                        </td>
										
                                        <td>
                                            <input name="NACNO[]" id="NACNO{{$no}}" type="text" value="{{$kasd->NACNO}}"
                                            class="form-control NACNO" readonly required>
                                        </td>
										
										<td>
                                            <input name="URAIAN[]" id="URAIAN{{$no}}" type="text" value="{{$kasd->URAIAN}}"
                                            class="form-control URAIAN" required>
                                        </td>
										<td>
                                            <input name="JUMLAH[]" onclick="select()" style="text-align: right"  onkeyup="hitung()" id="JUMLAH{{$no}}" type="text" value="{{$kasd->JUMLAH}}"
