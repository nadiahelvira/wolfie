	...
	//echo "</pre><br>";
      ...
      if($this->debughtml)
        ...
        switch($arraydata['type']){
			...
			//bos emg ada nulis VOucher # ? BETUL BOS...
			//semisal # e diilangi mau dicoba? BISA BOS SILAHKAN
			//coba box xml e diganti (yg lama dibackup gpp) diganti Voucher aja  BENTAR MAKSUDNYA JASPERREPORTNYA KAN..?
			// iya designere   SUDAH BOS msh sama, ok lanjut cek lg
