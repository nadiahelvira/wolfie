...
class HutController extends Controller
{
    ...
    public function index()
    {
        ...
        // ganti 3
        return view('otransaksi_hut.index');
    }
    ...
    public function getHut(Request $request)
    {
        ...
        $hut = DB::table('hut')->select('*')->where('PER', $periode)->where('GOL', 'Y')->orderBy('NO_BUKTI', 'ASC')->get();
        ...
        return Datatables::of($hut)
            ...
            ->addColumn('action', function ($row) {
                if (Auth::user()->hasRole("superadmin") || Auth::user()->hasRole("operational")) {
                    ...
                    $btnEdit = ($row->POSTED == 1) ? ' onclick= "alert(\'Transaksi ' . $row->NO_BUKTI . ' sudah diposting!\')" href="#" ' : ' href="hut/edit/' . $row->NO_ID . '" ';
                    //$btnDelete = ($row->POSTED==1) ? ' onclick= "alert(\'Transaksi '.$row->NO_BUKTI.' sudah diposting!\')" href="#" ' : ' href="hut/delete/'. $row->NO_ID .'" ' ;
                    $btnDelete = '';
                ...
                $actionBtn =
                    ...
                    <div class="dropdown show" style="text-align: center">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="hut/show/' . $row->NO_ID . '">
    ...
    public function create()
    {
        ...
        // ganti 8
        return view('otransaksi_hut.create');
    }
...
///////////////////////////////////////////////////////////////////////////
        ...
        return redirect('/hut')->with('statusInsert', 'Data baru berhasil ditambahkan');
    }
    ...
    public function show(Hut $hut)
    {
        ...
        return view('otransaksi_hut.show', $data);
    }
    ...
    public function edit(Hut $hut)
    {
        ...
        if ($hut->POSTED == 1) {
            return redirect('/hut')->with('status', 'Data ' . $hut->NO_BUKTI . ' sudah terposting');
        } else {
    ...
    public function update(Request $request, Hut $hut)
    {
        ...
        return redirect('/hut')->with('status', 'Data baru berhasil diedit');
    }
    ...
    public function destroy(Hut $hut)
    {
        ...
        // ganti 
        return redirect('/hut')->with('status', 'Data berhasil dihapus');
    }
}
